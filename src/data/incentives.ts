...
export const incentives: Record<StateCode, StateIncentive> = {
  ...
  ME: {
    ...
    summary:
      "Efficiency Maine heat pump rebates are active through Triennial Plan VI ($529.3M): $1,000–$3,000 per outdoor unit (all-other-whole-home systems) and $3,000–$9,000 lump sum (ducted), by income tier. A $500 per housing unit whole-home bonus runs March–December 2026. NEHPA funds in Maine flow through Efficiency Maine’s water heater discounts — no separate per-unit consumer discount. HEAR is limited to mobile homes and affordable multifamily. Federal 25C/25D ended Dec 31, 2025.",
    sources: [
      {
      ...
      {
        label: "Efficiency Maine — Mobile Home Initiative",
        url: "https://www.efficiencymaine.com/at-home/mobile-home-initiative/",
      },
      {
  ...
  IL: {
    ...
    lastUpdated: "2026-09-18",
    summary:
      "Federal tax credits expired. Utility rebates are the primary incentive: ComEd up to $2,000 ducted, Ameren Illinois up to $900 ducted, MidAmerican up to $713. Illinois HEAR has not been processed by DOE; HOMES is awarded and awaiting approval for a two-agency pilot.",
    sources: [
      {
  ...
  NC: {
    ...
    sources: [
      ...
      {
        label: "DOE \u2014 Program Notice 26-2 (HEAR fuel-switching removal)",
        url: "https://www.energy.gov/documents/program-notice-26-2",
      },
      {
