...
const strongStates: StateTier[] = [
  ...
  { code: "MD", name: "Maryland", headlineAmount: "Up to $15,000", primaryProgram: "EmPOWER Maryland", note: "75% of electrification costs covered, to $15,000 — $10,000 at Potomac Edison, which adds $4,000 per unit via Switch-to-Electric." },
  ...
  { code: "WA", name: "Washington", headlineAmount: "Up to $13,000", primaryProgram: "State HEAR + PSE", note: "State HEAR active (Climate Commitment Act, ~$103.6M, income-qualified); PSE up to $5,000; Seattle City Light $2,000. Federal HARP ($8,000/heat pump) in final preparation — not yet launched." },
...
const limitedStates: StateTier[] = [
  ...
  { code: "AK", name: "Alaska", headlineAmount: "$500–$17,500", primaryProgram: "ACES + Fairbanks change-out", note: "Location-dependent: ACES pays $4,000–$8,500 across 43 coastal communities and Fairbanks up to $17,500. Most other areas get $500–$1,000 in utility rebates. HEAR/HOMES not launched." },
  { code: "AR", name: "Arkansas", headlineAmount: "Up to $3,000", primaryProgram: "SWEPCO + OG&E", note: "SWEPCO pays $250–$600/ton (up to ~$3,000 per address); OG&E up to $3,000 near Fort Smith. Entergy Arkansas has no central HP rebate. HEAR/HOMES not launched." },
  { code: "KS", name: "Kansas", headlineAmount: "$300–$1,000", primaryProgram: "Evergy + KEPCo co-ops", note: "Evergy pays $500–$1,000 under KEEIA; KEPCo co-ops add $300–$600. Midwest Energy offers on-bill financing. HEAR/HOMES not launched." },
        ...
        <div className="container-narrow">
          ...
          <div className="space-y-3 mb-6">
            {[
              ...
              { rank: 3, code: "md", name: "Maryland", amount: "Up to $15,000", detail: "EmPOWER whole-home at BGE, Pepco, Delmarva and SMECO (75% of costs)" },
