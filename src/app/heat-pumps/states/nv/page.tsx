...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    publishedTime: "2026-03-23T11:45:42-05:00",
    modifiedTime: `${incentives.NV.lastUpdated}T00:00:00Z`,
  },
};
...
const articleJsonLd = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Nevada Heat Pump Rebates & Incentives (2026)",
  datePublished: "2026-03-23T11:45:42-05:00",
  dateModified: `${incentives.NV.lastUpdated}T00:00:00Z`,
  author: { "@type": "Organization", name: "Home Energy Basics", url: "https://homeenergybasics.com" },
  publisher: { "@type": "Organization", name: "Home Energy Basics", url: "https://homeenergybasics.com" },
  mainEntityOfPage: "https://homeenergybasics.com/heat-pumps/states/nv",
};
        ...
        <div className="container-narrow">
          ...
          <p className="text-sm text-gray-500">
            {nvIncentive.lastUpdated === nvIncentive.lastVerified ? (
              ...
              <>Updated {formatDate(nvIncentive.lastUpdated)} · Last verified {formattedDate} against official program sources</>
            )}
          </p>
