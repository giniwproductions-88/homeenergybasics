...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    modifiedTime: `${incentives.NH.lastUpdated}T00:00:00Z`,
  },
};
...
const articleJsonLd = {
  ...
  dateModified: `${incentives.NH.lastUpdated}T00:00:00Z`,
        ...
        <div className="container-narrow">
          ...
          <p className="text-sm text-gray-500">
            {nhIncentive.lastUpdated === nhIncentive.lastVerified ? (
              ...
              <>Updated {formatDate(nhIncentive.lastUpdated)} · Last verified {formattedDate} against official program sources</>
            )}
          </p>
