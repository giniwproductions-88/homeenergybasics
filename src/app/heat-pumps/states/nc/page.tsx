  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. The HEAR program only covers upgrading from a non-heat-pump system to a heat pump. If you already have a heat pump and need to replace it, HEAR does not apply. Note also that DOE Program Notice 26-2 (effective May 29, 2026) removed fuel-switching upgrades from HEAR and required launched programs to conform within three months. As of September 6, 2026, Energy Saver NC\u2019s published rules still state that rebates for those measures are available only when upgrading from a non-electric appliance, and the program shows no notice of change. Confirm current eligibility with Energy Saver NC before starting a project. You may still qualify for HOMES rebates (which are based on whole-home energy savings, not system type) or Duke Energy Smart $aver rebates \u2014 $350\u2013$900 for replacing an existing heat pump, or $2,000\u2013$2,500 for converting an existing heat pump to a dual-fuel, cold-climate, or geothermal system.",
        },
      },
    ],
  };
    ...
    <>
        ...
        <div className="container-narrow">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-5 md:col-span-2">
              <p className="font-semibold text-amber-800 mb-1">⚠ HEAR is only for switching to a heat pump — confirm fuel-switching eligibility</p>
              <p className="text-sm text-amber-900">The HEAR heat pump rebate only applies when upgrading from a non-heat-pump system. If you already have a heat pump and need to replace it, HEAR does not cover the heat pump itself. DOE Program Notice 26-2 (effective May 29, 2026) removed fuel-switching upgrades from HEAR and required launched programs to conform within three months. As of September 6, 2026, Energy Saver NC&apos;s published rules still state that rebates for those measures are available only when upgrading from a non-electric appliance, and the program shows no notice of change. Confirm current eligibility with Energy Saver NC before starting a project. HOMES whole-home rebates and Duke Energy&apos;s Smart $aver replacement rebate ($350–$900) remain alternatives.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container-narrow">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-5 mt-6">
            <p className="font-semibold text-amber-800 mb-1">⚠ Switching from gas, propane, or oil? Confirm HEAR eligibility before starting</p>
            <p className="text-sm text-amber-900">DOE Program Notice 26-2 (effective May 29, 2026) removed fuel-switching upgrades from HEAR and required launched programs to conform within three months. As of September 6, 2026, Energy Saver NC&apos;s published rules still state that rebates for those measures are available only when upgrading from a non-electric appliance, and the program shows no notice of change. Confirm current eligibility with Energy Saver NC before starting a project. Electric-resistance-to-heat-pump projects are unaffected, and HOMES remains fuel-neutral.</p>
          </div>
      ...
      <section className="bg-gray-50 py-12">
        <div className="container-narrow">
          ...
          <p className="text-sm text-gray-500 mt-4">
            Note: Duke Smart $aver has no rebate tier for converting a gas furnace to a heat pump — households making that switch rely on HEAR (subject to DOE Program Notice 26-2 — confirm current eligibility with Energy Saver NC) or HOMES for the heat pump itself. North Carolina has no state tax credit for heat pumps. No state loan program directly reduces the purchase price, though Carolina SURE and Duke Energy&apos;s Improve &amp; Save on-bill financing can help with the remaining balance.
          </p>
        </div>
      </section>
        ...
        <div className="container-narrow">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-5 mb-6">
            ...
            <p className="text-sm text-green-900">
              Homeowners with electric resistance strip heat (covers a large share of NC homes) — unaffected by the HEAR fuel-switching rule change. Propane or fuel oil users in rural and mountain areas — volatile fuel prices make heat pumps especially cost-effective, but confirm current HEAR eligibility with Energy Saver NC before starting, or plan on HOMES instead. Households below 150% AMI in any part of the state, where Energy Saver NC can cover 50–100% of costs. Manufactured home residents in eastern NC, where electric resistance heating is common and energy burdens are high.
            </p>
          </div>
      ...
      <section className="bg-gray-50 py-12">
        <div className="container-narrow">
          ...
          <div className="space-y-4">
            <div className="bg-white border border-gray-200 rounded-lg p-5">
              <p className="font-semibold text-gray-900">DOE rule change — Program Notice 26-2</p>
              <p className="text-sm text-gray-600 mt-1">DOE Program Notice 26-2 (effective May 29, 2026) removed fuel-switching upgrades from HEAR and required launched programs to conform within three months. As of September 6, 2026, Energy Saver NC&apos;s published rules still state that rebates for those measures are available only when upgrading from a non-electric appliance, and the program shows no notice of change. Confirm current eligibility with Energy Saver NC before starting a project.</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-5">
