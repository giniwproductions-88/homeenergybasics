...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    modifiedTime: `${incentives.AR.lastUpdated}T00:00:00Z`,
  },
};
...
const articleJsonLd = {
  ...
  dateModified: `${incentives.AR.lastUpdated}T00:00:00Z`,
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white py-12">
        <div className="container-narrow">
          ...
          <p className="text-sm text-gray-500">
            {arIncentive.lastUpdated === arIncentive.lastVerified ? (
              <>Updated {formattedDate} — verified against official program sources</>
            ) : (
              <>Updated {formatDate(arIncentive.lastUpdated)} · Last verified {formattedDate} against official program sources</>
            )}
          </p>
