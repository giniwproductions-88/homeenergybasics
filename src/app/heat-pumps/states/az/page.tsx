      ...
      <section className="bg-gray-50 py-12">
        <div className="container-narrow">
          ...
          <div className="bg-gray-100 rounded-lg p-5 mb-4">
            ...
            <p className="text-sm text-gray-700">For a typical ducted heat pump installation ($8,000–$12,000 before incentives), with HEAR figures assuming an upgrade from existing electric equipment: above 150% AMI in SRP territory, expect <strong>$6,875–$10,875 out of pocket</strong> after SRP Cool Cash. At 80–150% AMI with SRP, expect <strong>$2,875–$4,875</strong> after HEAR covers half the project cost and Cool Cash is applied. Below 80% AMI, out-of-pocket costs can approach <strong>$0</strong> when project costs fall within the rebate caps — though the program&apos;s own published figures show an average qualified heat pump project costing <strong>$13,263</strong>, leaving roughly <strong>$5,263</strong> out of pocket after the $8,000 cap — that figure works from the program&apos;s own average project cost rather than the range above, and before any utility rebate. In APS territory, above 150% AMI, expect to pay <strong>full price</strong> until HOMES launches.</p>
          </div>
          <p className="text-sm text-gray-500">
